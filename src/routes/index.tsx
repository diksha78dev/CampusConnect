      ...
      <section className="relative border-b-2 border-black bg-lime px-4 py-28 md:px-6 md:py-36">
        ...
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-8 max-w-[640px] font-mono text-sm leading-relaxed md:text-base">
            ...
            communities. Run events, grow membership, ship certificates — without the spreadsheet
            chaos.
          </p>
            ...
            {[
              {
                ...
                tone: "bg-lime",
                t: "Clubs first",
                d: "Every club gets a home page, member roster, and event calendar — no more Google Docs bureaucracy.",
              },
              {
                n: "02",
                tone: "bg-sky",
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <article className="neu-border bg-white p-6">
              ...
              <p className="font-mono text-sm leading-relaxed">
                Native iOS/Android app for door-scanning is in alpha. PWA works today.
              </p>
            </article>
          </div>
        </div>
